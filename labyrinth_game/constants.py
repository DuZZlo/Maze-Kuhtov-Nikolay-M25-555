...
ROOMS = {
    ...
    'library': {
        ...
        'armory': {
          ...
          'exits': {'south': 'library', 'north': 'goblin_room'},
    ...
    'goblin_room': {
        'description': 'Небольшая каморка, заваленная хламом. Посреди комнаты, сидит гоблин и точит свой клинок. Увидев вас, он замирает',
        'exits': {'south': 'armory', 'east': 'artifact_room'},
        'items': [],
        'puzzle': ('Схватка с гоблином (введите "удар уклонение удар")', 'удар уклонение удар')
    },
    'artifact_room': {
        'description': 'Комната пуста, если не считать огромного кристалла в ее центре. Он мерцает тусклым светом, а внутри него видна идеальная щель, будто кто-то разрезал камень пополам, а затем снова соединил.',
        'exits': {'west': 'goblin_room'},
        'items': ['treasure_key'],
        'puzzle': ('Воздух вокруг кристалла вибрирует. Кажется, он чего-то ждет. (подсказка: действие в два слова)', 'вставить меч')
    }
}
