...
ROOMS = {
    ...
    'goblin_room': {
        'description': 'Небольшая каморка, заваленная хламом.',
        'exits': {'south': 'armory', 'east': 'artifact_room'},
        'items': [],
        'puzzle': ('В хламе роется Гоблин, увидев вас, он нападает. Схватка с гоблином (введите "удар уклонение удар")', 'удар уклонение удар')
    },
    'artifact_room': {
